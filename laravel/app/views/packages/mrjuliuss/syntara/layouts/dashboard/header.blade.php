<div class="navbar main-bar navbar-default">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ route('home')}}" target="_new" style="padding: 0px !important;margin: 3px 3px 3px 10px;">
            <img src="{{ asset('assets/images/abbionet_logo.jpg') }}" />
    ...
    <div class="navbar-collapse collapse navbar-responsive-collapse">
        <ul class="nav navbar-nav">
            ...
            @if (Sentry::check())
                 <li class=""><a href="{{ route('trial') }}"><i class="glyphicon glyphicon-list"></i> <span> Trials List</span></a></li>
